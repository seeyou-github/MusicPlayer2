...
void CUserUi::ResetStartupPage()
{
    UiElement::StackElement* main_stack_element = FindElementInAllUi<UiElement::StackElement>("ui_big_main_stack_element");
    if (main_stack_element != nullptr)
        main_stack_element->SetCurrentElement(0);

    main_stack_element = FindElementInAllUi<UiElement::StackElement>("main_stack_element");
    if (main_stack_element != nullptr)
        main_stack_element->SetCurrentElement(0);
}

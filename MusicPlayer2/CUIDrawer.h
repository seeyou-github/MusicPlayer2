...
public:
    ...
    void SetLyricColors(const COLORREF* text_color, const COLORREF* playing_text_color);
...
private:
    ...
    COLORREF LyricTextColor() const;
    COLORREF LyricPlayingTextColor() const;
...
private:
    ...
    bool m_custom_lyric_text_color{};
    bool m_custom_lyric_playing_text_color{};
    COLORREF m_lyric_text_color{};
    COLORREF m_lyric_playing_text_color{};
};

...
public:
    ...
    static bool WriteMp3AlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteFlacAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteFlacAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteM4aAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteM4aAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteAsfAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteAsfAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteWavAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteWavAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteTtaAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteTtaAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteApeAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteApeAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteOggAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteOggAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteOpusAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteOpusAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteSpxAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteSpxAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);
    static bool WriteAiffAlbumCover(const wstring& file_path, const wstring& album_cover_path, bool remove_exist = true);
    static bool WriteAiffAlbumCover(const wstring& file_path, const string& album_cover_data, const wstring& ext, bool remove_exist = true);

...
{
	theApp.m_general_setting_data.minimize_to_notify_icon = theApp.m_app_setting_data.show_notify_icon && IsDlgButtonChecked(IDC_MINIMIZE_TO_NOTIFY_RADIO) != FALSE;

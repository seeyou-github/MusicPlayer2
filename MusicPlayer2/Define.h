...
#define APP_VERSION L"2.78"	//程序版本
#define COPY_RIGHT_YEAR L"2025"
...
//仅当列表元素的内容发生了改变但是总行数未变的情况下需要发送此消息，行数变化的情况已经在UiElement::AbstractListElement::OnRowCountChanged中处理
...
#define WM_TAB_WINDOW_REQUIRED (WM_USER+143)    //Tab控件需要父窗口创建指定标签页子窗口

#define WM_NEXT_USER_MSG (WM_USER+144)

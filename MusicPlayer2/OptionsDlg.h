...
protected:
    ...
    std::vector<bool> m_tab_created;

    virtual CString GetDialogName() const override;
    virtual bool InitializeControls() override;
    virtual void DoDataExchange(CDataExchange* pDX);    // DDX/DDV 支持
    bool CreateTabPage(int index);
    void SetCreatedTabScrollbarInfo(int index);
    bool IsTabCreated(int index) const;
...
public:
    ...
    afx_msg LRESULT OnTabWindowRequired(WPARAM wParam, LPARAM lParam);
};

...
BOOL CDataSettingsDlg::OnInitDialog()
{
    ...
    CheckDlgButton(IDC_SAVE_TO_APPDATA_RADIO, FALSE);
    CheckDlgButton(IDC_SAVE_TO_PROGRAM_DIR_RADIO, TRUE);
    GetDlgItem(IDC_SAVE_TO_APPDATA_RADIO)->ShowWindow(SW_HIDE);
    GetDlgItem(IDC_SAVE_TO_PROGRAM_DIR_RADIO)->ShowWindow(SW_HIDE);
    ...
    if (m_data.minimize_to_notify_icon && theApp.m_app_setting_data.show_notify_icon)
